...
class SeqSeq(vregs: HWRegPool, pregs: HWRegPool, sregs: HWRegPool, aregs: HWRegPool, xregs: HWRegPool, mem: Mem, nseqs: Int, mixcfg: Map[String,Int], use_mul: Boolean, use_div: Boolean, use_mix: Boolean, use_fpu: Boolean, use_fma: Boolean, use_fcvt: Boolean, use_amo: Boolean) extends VFInstSeq
{
  ...
  val name_to_seq = Map(
    "vmem" -> (() => new SeqVMem(xregs, vregs, aregs, mem.asInstanceOf[VMem], use_amo)), // TODO: Clean up
